  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
      ...
      >
        ...
        <div className="w-16 h-16 bg-rose-50 text-rose-500 rounded-full flex items-center justify-center mb-6 mt-2">
          <LogOut size={32} />
        </div>

        <h2 className="text-2xl font-black text-slate-800 tracking-tight mb-2">¿Cerrar Sesión?</h2>
        <p className="text-sm font-medium text-slate-500 mb-8 max-w-[280px]">
          Estás a punto de salir de la cuenta de vendedor actual. Se cerrará la sesión actual pero tus datos guardados no se perderán.
        </p>
        ...
        <div className="flex gap-4 w-full">
          ...
          <button 
            onClick={onConfirm}
            className="flex-1 py-3.5 bg-rose-500 hover:bg-rose-600 transition-colors text-white rounded-2xl text-xs font-black uppercase tracking-widest shadow-lg shadow-rose-200"
          >
            Cerrar Sesión
          </button>
        </div>
